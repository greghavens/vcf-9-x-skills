...
| **vSAN / unified session** | `[9.0]` | Session established on vSphere Web Services API (`/vim25`) can be reused on vSphere Automation API (`/api`); both recognize `vmware-api-session-id`. VCF SDK 9.0 consolidates vSphere, vSAN, vSAN Data Protection and SDDC Manager. | — | — | `vmware-api-session-id` | S58 (Broadcom/VMware blog, 2025-11-19) |
