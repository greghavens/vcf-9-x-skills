# How to answer (shared across all VCF skills)

This block is appended to every VCF skill's SKILL.md. It exists because the reference
files in these skills are deliberately dense — they are lookup material, written for
completeness — and an agent that mistakes "what I now know" for "what I should say"
produces a wall of text in response to a two-line question.
