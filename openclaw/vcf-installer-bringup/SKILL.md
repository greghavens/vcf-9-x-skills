      ...
      "envVars": [
        {
          "name": "VCF_BOOTSTRAP",
          "required": false,
          "description": "Optional: VCF_BOOTSTRAP used in worked examples"
        },
        {
          "name": "VCF_COMPLETE",
          "required": false,
          "description": "Optional: VCF_COMPLETE used in worked examples"
        },
        {
          "name": "VCF_EXTEND",
          "required": false,
          "description": "Optional: VCF_EXTEND used in worked examples"
        }
      ]
    }
  }
